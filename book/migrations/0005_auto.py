...
class Migration(SchemaMigration):
    ...
    models = {
        u'book.author': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Author', '_ormbases': [u'pages.Page']},
        ...
        u'book.book': {
            ...
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Book', '_ormbases': [u'pages.Page']},
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
        ...
        u'book.excerpt': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Excerpt', '_ormbases': [u'pages.Page']},
            'book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'excerpts'", 'blank': 'True', 'to': u"orm['book.Book']"}),
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'pages.page': {
